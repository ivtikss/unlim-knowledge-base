...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('KnowledgeBase', '0006_alter_certification_дата_начала_действия_лицензии_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateField(default=datetime.datetime(2023, 6, 23, 11, 20, 20, 419097)),
        ),
        migrations.AlterField(
            model_name='infodeal',
            name='Дата начала действия лицензии',
        ...
        migrations.AlterField(
            ...
            field=models.DateField(default=datetime.datetime(2023, 6, 23, 11, 20, 20, 419097), max_length=50),
        ),
        migrations.AlterField(
