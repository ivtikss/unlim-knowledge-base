...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('KnowledgeBase', '0010_alter_certification_дата_начала_действия_лицензии_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateField(default=datetime.datetime(2023, 6, 23, 11, 35, 13, 694683)),
        ),
        migrations.AlterField(
            model_name='infodeal',
            name='Дата начала действия лицензии',
        ...
        migrations.AlterField(
            ...
            field=models.DateField(default=datetime.datetime(2023, 6, 23, 11, 35, 13, 694683), max_length=50),
        ),
        migrations.AlterField(
